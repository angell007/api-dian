...
class Company extends Model
{
     ...
     */
    protected $hidden = [
        'software', 'certificate', 'resolutions', 'language', 'tax', 'country', 'type_document_identification', 'type_operation', 'type_environment', 'type_currency', 'type_organization', 'municipality', 'type_liability', 'type_regime', 'IndustryClassificationCode'
    ];
    ...
    {
        return $this->hasOne(Software::class)->where('type','FE');
    }
    /**
     * Get the software record associated with the company.
     */
    public function software_nomina()
    {
        return $this->hasOne(Software::class)->where('type','NE');
    }
