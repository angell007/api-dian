...
class CreditNoteController extends Controller
{
    ...
    public function store(CreditNoteRequest $request)
    {
        ...
        // Customization ID override (used for credit note operation code when needed)
        $customizationId = $request->customization_id ?? null;

        // Create XML
        $crediNote = $this->createXML(compact('user', 'company', 'customer', 'taxTotals', 'resolution', 'paymentForm', 'typeDocument', 'creditNoteLines', 'allowanceCharges', 'legalMonetaryTotals', 'billingReference', 'date', 'time', 'cufe_propio', 'customizationId'));
    ...
    public function testSetStore(CreditNoteRequest $request, $testSetId)
    {
        ...
        // Create XML
        $crediNote = $this->createXML(compact('user', 'company', 'customer', 'taxTotals', 'resolution', 'paymentForm', 'typeDocument', 'creditNoteLines', 'allowanceCharges', 'legalMonetaryTotals', 'billingReference', 'date', 'time', 'customizationId'));
