...
class ReceiptGoodOrServiceController extends Controller
{
     ...
     * Store.
     *
     * @param \App\Http\Requests\Api\ReceiptGoodOrServiceRequest $request
     *
     * @return \Illuminate\Http\Response
     */
    public function store(ReceiptGoodOrServiceRequest $request)
    {
        // User
     ...
     * @return \Illuminate\Http\Response
     */
    public function testSetStore(ReceiptGoodOrServiceRequest $request, $testSetId)
    {
     
        $environment = InvoiceReceivedController::envirom['debug'];
