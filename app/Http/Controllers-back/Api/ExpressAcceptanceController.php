...
use Carbon\Carbon;
use App\Http\Requests\Api\ExpressAcceptancRequest;

class ExpressAcceptanceController extends Controller
{
     ...
     * Store.
     *
     * @param \App\Http\Requests\Api\ExpressAcceptancRequest $request
     *
     * @return \Illuminate\Http\Response
     */
    public function store(ExpressAcceptancRequest $request)
    {
        // User

        $environment = PayrollController::envirom['production'];
        ...
        //   echo json_encode($sendExpressAcceptanceAsync->contentFile); exit;
     ...
     * @return \Illuminate\Http\Response
     */
    public function testSetStore(ExpressAcceptancRequest $request, $testSetId)
    {
