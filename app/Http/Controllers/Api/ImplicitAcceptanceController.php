...
use Carbon\Carbon;
use App\Http\Requests\Api\ImplicitAcceptancRequest;

class ImplicitAcceptanceController extends Controller
{
     ...
     * Store.
     *
     * @param \App\Http\Requests\Api\ImplicitAcceptancRequest $request
     *
     * @return \Illuminate\Http\Response
     */
    public function store(ImplicitAcceptancRequest $request)
    {
        // User
 
        $environment = ImplicitAcceptanceController::envirom['production'];
     ...
     * @return \Illuminate\Http\Response
     */
    public function testSetStore(ImplicitAcceptancRequest $request, $testSetId)
    {
     

        $environment = ImplicitAcceptanceController::envirom['debug'];
