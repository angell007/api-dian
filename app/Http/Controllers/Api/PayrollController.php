   ...
   public function store(Request $request)
    {
       ...
       $payroll = $this->createXML(compact('user','typeDocument','company' ,'header', 'resolution',
                                        'person' ,'pay' , 'accrued', 'deductions', 'totals','header'));
        
        
       // Signature XML
        $signCreditNote = new SignPayroll($company->certificate->path, $company->certificate->password );
        ...
        $sendTestSetAsync->fileName = "nie.xml";
    ...
    public function testSetStore(PayrollRequest $request, $testSetId)
    {
        ...
        $header->date_start_period =  $request->date_start_period ;
        $header->date_end_period =  $request->date_end_period ;
        $header->qr = 'https://catalogo-vpfe-hab.dian.gov.co/document/searchqr?documentkey='.$header->cune_propio;
