<cac:AccountingSupplierParty>
    ...
    <cac:Party>
        ...
        @php
            ...
            // Obtener DV del proveedor/cliente
            $supplierDv = null;
            $supplierIdentification = $customer->company->identification_number;
            
            // Si es NIT y está concatenado, separarlo
            if ($isNit && strlen($supplierIdentification) == 10) {
                $supplierIdentification = substr($supplierIdentification, 0, 9);
                $supplierDv = substr($customer->company->identification_number, 9, 1);
            } elseif ($isNit) {
                $supplierDv = $customer->company->dv ?? null;
            }
        @endphp
